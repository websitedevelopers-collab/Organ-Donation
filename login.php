...
.wrapper{
  ...
  background: #FFF5EE;
  margin: 50px auto;
  box-shadow: 2px 2px 4px rgba(46, 46, 46, 0.13);
  padding: 30px;
}
...
.wrapper .form .inputfield .input {
  width: 100%;
  outline: none;
  border: 1px solidrgb(255, 221, 159);
  font-size: 15px;
  padding: 8px 10px;
  border-radius: 3px;
